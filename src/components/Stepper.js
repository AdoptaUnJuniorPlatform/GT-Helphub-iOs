...
const Stepper = ({ step = "1" }) => {
  ...
  return (
    <View className="pt-3">
      ...
      <View
        className="absolute top-2 w-[32px] h-[32px] rounded-full bg-neutral-color-blue-gray-50 justify-center items-center"
        style={{
          left: `${constrainedLeft}%`,
          transform: [{ translateX: -16 }],
        }}
      >
        <FontAwesome6 name="user-large" size={14} color="#607d8a" />
      </View>
    </View>
  );
};
